...
build_and_run_combination:
	...
	jsrl-corl python $(RUN_FILE) --env CombinationLock-v0 --learner_frac 0.09 --guide_heuristic_fn combination_lock --offline_iterations 0 --env_config '{"horizon": 5}' --eval_freq 500 --beta 10 --iql_tau 0.9 --horizon_fn time_step --name IQL-test --device cpu --online_iterations 1000 ;
